...
if ($_SERVER['REQUEST_METHOD'] === 'GET' && trim($_GET["actionType"]) == 'edit') {
    ...
    $query   = "SELECT *
    FROM PLAZA_PARENT  WHERE ID = $edit_id";
        ...
        <div class="row">
            <div class="col-12">
                <div class="card rounded-4">
                    <?php
                    $headerType    = 'Edit';
                    $leftSideName  = 'Retailer Type Edit';
                    ...
                    <div class="card-body">
                        <div class="p-4 border rounded">
                            <form action="<?php echo ($sfcmBasePath . '/admin_module/action/plaza_retailer_panel.php') ?>" method="POST" class="row g-3 needs-validations">

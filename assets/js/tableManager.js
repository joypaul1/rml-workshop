    ...
    $.fn.tablemanager = function (options = null) {
        ...
        if (options !== null) {
            ...
            **/
            if (pagination === true || Table.hasClass("tablePagination")) {
                ...
                var pagesDiv =
                    '<div id="pagesControllers" class="btn-group pagesControllers" role="group" aria-label="Basic group"></div>';
            ...
            **/
            if (
                ...
                var filterbyDiv =
                    ...
                    ': </label><select style="display: none;" id="filter_by"></select> <input id="filter_input" type="text" placeholder="' +
        ...
        **/
        function generatePaginationValues() {
            ...
            $(".pagecontroller-num").eq(0).addClass("active");
        ...
        function appendPageControllers(nPages) {
            ...
            $("#pagesControllers").append(
                $("<button>", {
                    value: "first",
                    text: "<<",
                    class: "btn btn-outline-primary pagecontroller pagecontroller-f ",
                })
            );
            // Previous
            $("#pagesControllers").append(
                $("<button>", {
                    value: "prev",
                    text: "<",
                    class: "btn btn-outline-primary pagecontroller pagecontroller-p",
                })
            );
            // Numbers
            for (i = 1; i <= nPages; i++) {
                $("#pagesControllers").append(
                    $("<button>", {
                        value: i,
                        text: i,
                        class: "btn btn-outline-primary pagecontroller pagecontroller-num",
                    })
                );
            }
            // Next
            $("#pagesControllers").append(
                $("<button>", {
                    value: "next",
                    text: ">",
                    class: "btn btn-outline-primary pagecontroller pagecontroller-n",
                })
            );
            // Last
            $("#pagesControllers").append(
                $("<button>", {
                    value: "last",
                    text: ">>",
                    class: "btn btn-outline-primary pagecontroller pagecontroller-l",
                })
            );
        }
        ...
        **/
        function pagecontrollersClick() {
            $(".pagecontroller").on("click", function () {
                ...
                $(".pagecontroller-num").removeClass("active");
                $(".pagecontroller-num")
                    .eq(currentPage)
                    .addClass("active");

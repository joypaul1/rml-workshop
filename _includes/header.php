...
<head>
    ...
    <link href="<?php echo $cspdBasePath ?>/assets/plugins/vectormap/jquery-jvectormap-2.0.2.css" rel="stylesheet">
    <link href="<?php echo $cspdBasePath ?>/assets/plugins/simplebar/css/simplebar.css" rel="stylesheet">
    <link href="<?php echo $cspdBasePath ?>/assets/plugins/perfect-scrollbar/css/perfect-scrollbar.css" rel="stylesheet">
    <link href="<?php echo $cspdBasePath ?>/assets/plugins/metismenu/css/metisMenu.min.css" rel="stylesheet">
    <!-- loader-->
<link href="<?php echo $cspdBasePath ?>/assets/css/pace.min.css" rel="stylesheet">
    <script src="<?php echo $cspdBasePath ?>/assets/js/pace.min.js"></script>
    <!-- Bootstrap CSS -->
    ...
    <!-- Theme Style CSS -->
    <!-- <link rel="stylesheet" href="<?php echo $cspdBasePath ?>/assets/css/dark-theme.css"> -->
    <!-- <link rel="stylesheet" href="<?php echo $cspdBasePath ?>   /assets/css/semi-dark.css"> -->
    <link rel="stylesheet" href="<?php echo $cspdBasePath ?>/assets/css/header-colors.css">
